...
SELECT
  ...
  v.vendor_name,
  v.vendor_type,
  (v.vendor_owner_first_name || ' ' || v.vendor_owner_last_name) AS vendor_owner,
  vba.market_date,
  vba.booth_number
FROM vendor AS v
...
*/
-- Create a temporary copy of the vendor table
DROP TABLE IF EXISTS new_vendor;

CREATE TEMP TABLE new_vendor AS
SELECT * FROM vendor;

-- Insert a new 10th vendor (match the actual column names)
